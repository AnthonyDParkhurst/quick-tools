...
dotnet PanzyCopy.dll --dest D:\Cached --get "Kofax*.zip" --get "Kofax*.iso" --get TSAutomation.ZIP --get DLInternal.zip --get RepositoryBrowser.ZIP --get TA_lib.ZIP --get Unobfuscated_ThinClient.zip --skip "KofaxTotalAgility*Azure*" --skip "KofaxTotalAgility*IS*" --skip "KofaxTotalAgility*OPMT*" --skip "KofaxTotalAgilityDocumentation*" %*
